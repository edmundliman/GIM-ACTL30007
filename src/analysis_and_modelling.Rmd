...
claimgof$chisqtable
```
We will be using Weibull distribution with shape = 2.286708 and scale = 1628.721687
...
weibull.scale
mean(claim[claim > 0])
weibull.scale * gamma(1+1/weibull.shape)
var(claim[claim > 0])
(weibull.scale ^ 2) * (gamma(1 + 2/weibull.shape) - (gamma(1 + 1/ weibull.shape)) ^ 2)
```
